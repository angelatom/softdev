#Team historicalevents (cookie): Angela Tom & Simon Tsui
#SoftDev pd7
#K #06: Yummy Mongo Py
#2/28/19

#We chose the historical events database which includes the dates and description of recorded events
#Raw data source:http://www.vizgr.org/historical-events/search.php?format=json&begin_date=-30000000&end_date=20151231&lang=en
